    ...
    <div class="dashboard__container">
      ...
      <div class="views__buttons-container">
        <span>
          ...
          <a href="<?= ROOT_URL ?>view-men.php" class="view-btn">Men</a>
        </span>
        <span>
        ...
        <span>
          ...
          <a href="<?= ROOT_URL ?>view-children.php" class="view-btn active">Children</a>
        </span>
      </div>
      ...
      <div class="data__container">
        <div class="tabular__wrapper">
          <div class="flex">
            <h4 class="recent-hd">Recently Added Children</h4>
            ...
            <div class="ell-dropdown tbl-dropdown">
              ...
              <a href="<?= ROOT_URL ?>reports/children.php" class="ell-dpd-btn">
                  ...
                  <tr>
                    ...
                    <td style="text-align: center;">
                      <?php if ($record['status'] === 'Active') : ?>
                        <a href="<?= ROOT_URL ?>page/children-profile.php?children_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="Active" class="status-btn active"><i class="fa fa-check-circle"></i></a>
                      <?php elseif ($record['status'] === 'Normal') : ?>
                        <a href="<?= ROOT_URL ?>page/children-profile.php?children_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="Normal" class="status-btn normal"><i class="fa fa-exclamation-circle"></i></a>
                      <?php else : ?>
                        <a href="<?= ROOT_URL ?>page/children-profile.php?children_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="InActive" class="status-btn inactive"><i class="fa fa-times-circle"></i></a>
                      <?php endif ?>
                    </td>
                    <td>
