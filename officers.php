...
#getting data
$title = $_SESSION['add-officer-data']['title'] ?? null;
$group_name = $_SESSION['add-officer-data']['group_name'] ?? null;
$marital_status = $_SESSION['add-officer-data']['marital_status'] ?? null;
$name = $_SESSION['add-officer-data']['name'] ?? null;
$residence = $_SESSION['add-officer-data']['residence'] ?? null;
$email = $_SESSION['add-officer-data']['email'] ?? null;
$contact = $_SESSION['add-officer-data']['contact'] ?? null;

unset($_SESSION['add-officer-data']);
?>
  ...
  <aside class="sidebar sticky">
    <div class="container flex-column">
      ...
      <ul class="navbar">
        ...
        <li class="nav-item">
          <a href="<?= ROOT_URL ?>officers.php" class="nav-link active">
  ...
  <div class="main__container">
    ...
    <header class="header">
      ...
      <div class="search__container">
        <form action="<?= ROOT_URL ?>search/officers.php" method="get" autocomplete="off" class="form">
          <input type="text" name="search" class="box" placeholder="search officers here...">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Add New Officer</h4>
      ...
      <div class="officers__form-container">
        ...
        <?php
        #officers form
        require_once "./forms/__officers-form.php";
        ?>
      </div>
        ...
        <div class="tabular__wrapper">
          <div class="flex">
            ...
            <div class="ell-dropdown tbl-dropdown">
              <a href="<?= ROOT_URL ?>view-officers.php" class="ell-dpd-btn">
                <span class="primary"><i class="fa fa-eye"></i></span>&emsp;View
              </a>
              <a href="<?= ROOT_URL ?>reports/officers.php" class="ell-dpd-btn">
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <?php if ($record['status'] === 'Active') : ?>
                      <a href="<?= ROOT_URL ?>page/officer-profile.php?officer_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="Active" class="status-btn active"><i class="fa fa-check-circle"></i></a>
                    <?php elseif ($record['status'] === 'Normal') : ?>
                      <a href="<?= ROOT_URL ?>page/officer-profile.php?officer_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="Normal" class="status-btn normal"><i class="fa fa-exclamation-circle"></i></a>
                    <?php else : ?>
                      <a href="<?= ROOT_URL ?>page/officer-profile.php?officer_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="InActive" class="status-btn inactive"><i class="fa fa-times-circle"></i></a>
                    <?php endif ?>
                  </td>
                  <td>
                    <span class="td-action">
                      <a target="_parent" title="Edit" href="<?= ROOT_URL ?>edit/edit-officers.php?edit_officers_id_number=<?= $record['id'] ?>" class="atn-btn edit"><span><i class="fa fa-user-edit"></i></span></a>
                      <a target="_parent" title="Delete" href="<?= ROOT_URL ?>logic/delete-officers.php?delete_officers_id_number=<?= $record['id'] ?>" class="atn-btn delete"><span><i class="fa fa-trash-can"></i></span></a>
                    </span>
                  </td>
                </tr>
              <?php
