...
<main class="main__wrapper">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <div class="flex">
        <a href="<?= ROOT_URL ?>index.php" class="btn-title">Dashboard</a>
        <a href="<?= ROOT_URL ?>membership.php" class="btn-title active">Membership</a>
      </div>

      <?php
      require_once "./sub-templates/__membership-cards.php";
      ?>
