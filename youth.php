...
#getting data
$name = $_SESSION['add-youth-data']['name'] ?? null;
$residence = $_SESSION['add-youth-data']['residence'] ?? null;
$email = $_SESSION['add-youth-data']['email'] ?? null;
$contact = $_SESSION['add-youth-data']['contact'] ?? null;
$school = $_SESSION['add-youth-data']['school'] ?? null;

unset($_SESSION['add-youth-data']);
?>
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <aside class="sidebar sticky">
    <div class="container flex-column">
      ...
      <ul class="navbar">
        ...
        <li class="nav-item">
          <a href="<?= ROOT_URL ?>youth.php" class="nav-link active">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Add New Youth</h4>
      <div class="officers__form-container">
        ...
        <?php
        #youth form
        require_once "./forms/__youth-form.php";
        ?>
        ...
        <div class="tabular__wrapper">
          <div class="flex">
            ...
            <div class="ell-dropdown tbl-dropdown">
              <a href="<?= ROOT_URL ?>view-youth.php" class="ell-dpd-btn">
                <span class="primary"><i class="fa fa-eye"></i></span>&emsp;View
              </a>
              <a href="<?= ROOT_URL ?>reports/youth.php" class="ell-dpd-btn">
          ...
          <?php
          $sno = 1;
          $query = " SELECT * FROM youth ORDER BY id DESC";
                ...
                <tr>
                  ...
                  <td style="text-align: center;">
                    <?php if ($record['status'] === 'Active') : ?>
                      <a href="<?= ROOT_URL ?>page/youth-profile.php?youth_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="Active" class="status-btn active"><i class="fa fa-check-circle"></i></a>
                    <?php elseif ($record['status'] === 'Normal') : ?>
                      <a href="<?= ROOT_URL ?>page/youth-profile.php?youth_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="Normal" class="status-btn normal"><i class="fa fa-exclamation-circle"></i></a>
                    <?php else : ?>
                      <a href="<?= ROOT_URL ?>page/youth-profile.php?youth_profile_id_numder=<?= $record['id'] ?>" target="_parent" title="InActive" class="status-btn inactive"><i class="fa fa-times-circle"></i></a>
                    <?php endif ?>
                  </td>
                  <td>
                    <span class="td-action">
                      <a target="_parent" title="Edit" href="<?= ROOT_URL ?>edit/edit-youth.php?edit_youth_id_number=<?= $record['id'] ?>" class="atn-btn edit"><span><i class="fa fa-user-edit"></i></span></a>
                      <a target="_parent" title="Delete" href="<?= ROOT_URL ?>logic/delete-youth.php?delete_youth_id_number=<?= $record['id'] ?>" class="atn-btn delete"><span><i class="fa fa-trash-can"></i></span></a>
                    </span>
                  </td>
                </tr>
              <?php
