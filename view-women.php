  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      ...
      <div class="views__buttons-container">
        ...
        <span>
          <a href="<?= ROOT_URL ?>view-women.php" class="view-btn active">Women</a>
      ...
      <div class="data__container">
        <div class="tabular__wrapper">
          <div class="flex">
            <h4 class="recent-hd">Available Women Data</h4>
          ...
          <?php
          $sno = 1;
          $query = " SELECT * FROM members WHERE title='Sis' ORDER BY id DESC";
