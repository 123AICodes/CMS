<div class="form__container">
  <form action="<?= ROOT_URL ?>logic/add-officers-logic.php" autocomplete="off" class="form" method="post" enctype="multipart/form-data">
    <div class="flex">
      <div class="inputBox">
        <span>Title</span>
    ...
    <button class="submit-btn" name="add-officer">Add Officer</button>
  </form>
</div>