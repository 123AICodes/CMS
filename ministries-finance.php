...
$ministry = $_SESSION['add-finance-data']['ministry'] ?? null;
...
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Ministries Finance</h4>
      <div class="finance__buttons">
        <a href="<?= ROOT_URL ?>finance.php" class="fn-btn">New Data</a>
        <a href="<?= ROOT_URL ?>ministries-finance.php" class="fn-btn active">Ministries</a>
      </div>
      <div class="officers__form-container">
        ...
        #form
        require_once "./forms/__min-finance-form.php";
        ?>
      </div>
