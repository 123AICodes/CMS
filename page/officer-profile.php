...
if (isset($_GET['officer_profile_id_numder'])) {
  $member_id = filter_var($_GET['officer_profile_id_numder'], FILTER_SANITIZE_NUMBER_INT);
  $query = " SELECT * FROM officers WHERE id='$member_id' ";
...
<main class="m-prof">
  ...
  <main class="member__profile-container">
    <div class="prev_wrp">
      <a href="<?= ROOT_URL ?>officers.php" target="_parent" title="Go Back" class="previous">
