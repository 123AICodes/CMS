  ...
  <div class="data__container">
    <?php if (mysqli_num_rows($results) > 0) : ?>
      ...
      <div class="tabular__wrapper">
        ...
        $query2 = " SELECT * FROM members WHERE title='Agya' OR title='Bro'";
        $query3 = " SELECT * FROM members WHERE title='Eno' OR title='Sis'";
        $query4 = " SELECT * FROM members WHERE title='Eno' OR title='Agya'";
        ...
        <!-- total -->
        <div class="total">
          <small>Men: <?php echo $results2 ?? 0 ?></small>
          <small>Aged: <?php echo $results4 ?? 0 ?></small>
          <small>Women: <?php echo $results3 ?? 0 ?></small>
          <small>Membership: <?php echo $results1 ?? 0 ?></small>
        </div>
      </div>
