  ...
  <div class="data__container">
    <?php if (mysqli_num_rows($results) > 0) : ?>
      ...
      <div class="tabular__wrapper">
        ...
        $query2 = " SELECT * FROM children WHERE title='Bro'";
        $query3 = " SELECT * FROM children WHERE title='Sis'";
        ...
        <!-- total -->
        <div class="total">
          <small>Boys: <?php echo $results2 ?? 0 ?></small>
          <small>Girls: <?php echo $results3 ?? 0 ?></small>
