...
#getting data
$name = $_SESSION['add-child-data']['name'] ?? null;
$residence = $_SESSION['add-child-data']['residence'] ?? null;
$mother = $_SESSION['add-child-data']['mother'] ?? null;
$father = $_SESSION['add-child-data']['father'] ?? null;
$contact = $_SESSION['add-child-data']['contact'] ?? null;
$school = $_SESSION['add-child-data']['school'] ?? null;

unset($_SESSION['add-child-data']);
?>
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <aside class="sidebar sticky">
    <div class="container flex-column">
      ...
      <ul class="navbar">
        ...
        <li class="nav-item">
          <a href="<?= ROOT_URL ?>children.php" class="nav-link active">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Add New Child</h4>
      <div class="officers__form-container">
        ...
        <?php
        #youth form
        require_once "./forms/__children's-form.php";
        ?>
        ...
        <div class="tabular__wrapper">
          <div class="flex">
            ...
            <div class="ell-dropdown tbl-dropdown">
              <a href="<?= ROOT_URL ?>index.php" class="ell-dpd-btn">
