...
$contact = $_SESSION['add-member-data']['contact'] ?? null;
...
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <aside class="sidebar sticky">
    <div class="container flex-column">
      ...
      <ul class="navbar">
        ...
        <li class="nav-item">
          <a href="<?= ROOT_URL ?>members.php" class="nav-link active">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Add New Member</h4>
      <div class="officers__form-container">
        ...
        <?php
        #members form
        require_once "./forms/__members-form.php";
        ?>
