...
<main class="main__wrapper">
  ...
  <aside class="sidebar sticky">
    <div class="container flex-column">
      ...
      <ul class="navbar">
        <li class="nav-item">
          <a href="<?= ROOT_URL ?>index.php" class="nav-link active">
  ...
  <div class="main__container">
    ...
    <header class="header">
      ...
      <button class="search-btn-small" name="search-btn"><i class="fa fa-search"></i></button>
    ...
    <div class="dashboard__container">
      <div class="flex">
        <a href="<?= ROOT_URL ?>index.php" class="btn-title active">Dashboard</a>
        <a href="<?= ROOT_URL ?>membership.php" class="btn-title">Membership</a>
      </div>

      <?php
      #cards
      require_once "./sub-templates/__dashboard-cards.php";
      ?>
        ...
        <div class="tabular__wrapper">
          <div class="flex">
            ...
            <div class="ell-dropdown tbl-dropdown">
              <a href="<?= ROOT_URL ?>view-members.php" class="ell-dpd-btn">
