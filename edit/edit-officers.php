...
if (isset($_GET['edit_officers_id_number'])) {
  $officer_id = filter_var($_GET['edit_officers_id_number'], FILTER_SANITIZE_NUMBER_INT);
  $query = " SELECT * FROM officers WHERE id='$officer_id' ";
  $query_result = mysqli_query($connection, $query);
  $officer = mysqli_fetch_assoc($query_result);
} else {
...
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Update Officer</h4>

      <div class="officers__form-container">
        <?php
        require_once "../forms/__edit-officers-form.php";
        ?>
      </div>
                ...
                <tr>
                  ...
                  <td>
                    <span class="td-action">
                      <a target="_parent" title="Edit" href="<?= ROOT_URL ?>edit-officers.php?edit_officers_id_number=<?= $record['id'] ?>" class="atn-btn edit"><span><i class="fa fa-user-edit"></i></span></a>
