...
if (isset($_GET['edit_youth_id_number'])) {
  $youth_id = filter_var($_GET['edit_youth_id_number'], FILTER_SANITIZE_NUMBER_INT);
  $query = " SELECT * FROM youth WHERE id='$youth_id' ";
  $query_result = mysqli_query($connection, $query);
  $youth = mysqli_fetch_assoc($query_result);
} else {
...
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Edit Youth</h4>
      <div class="officers__form-container">

        <?php
        require_once "../forms/__edit-youth-form.php";
        ?>
      </div>
