...
if (isset($_GET['edit_member_id_number'])) {
  $member_id = filter_var($_GET['edit_member_id_number'], FILTER_SANITIZE_NUMBER_INT);
...
<main class="main__wrapper" style="opacity: 1; display:grid;">
  ...
  <div class="main__container">
    ...
    <div class="dashboard__container">
      <h4 class="sub-title">Edit Member</h4>
      <div class="officers__form-container">

        <?php
        require_once "../forms/__edit-members-form.php";
        ?>
